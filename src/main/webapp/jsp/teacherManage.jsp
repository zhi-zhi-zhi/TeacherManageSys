...
<%--    &lt;%&ndash; bootstrap-validator 基于 bootstrap3 &ndash;%&gt;--%>
...
<%--    <script src="https://cdn.bootcss.com/jquery.bootstrapvalidator/0.5.3/js/bootstrapValidator.min.js"></script>--%>
    ...
    <script src="../js/entityConfig.js" type="text/javascript"></script>
    <script src="../js/entityManageModal.js" type="text/javascript" async="async"></script>
    <script src="../js/entityManageTable.js" type="text/javascript" async="async"></script>
</head>
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form style="width: 80%; margin: 0 auto" id="myForm">
